...
from src.tasks.masakhaner.prompts import ENTITY_DEFINITIONS, ENTITY_DEFINITIONS_woDATE
from src.tasks.utils_scorer import SpanScorer
from src.tasks.utils_typing import Entity


class MasakhaNEREntityScorer(SpanScorer):
    """MasakhaNER Entity identification and classification scorer."""
...
class MasakhaNEREntityScorerNoDATE(SpanScorer):
    """MasakhaNER Entity identification and classification scorer."""
