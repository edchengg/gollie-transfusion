...
class MULTITACREDDatasetLoader(DatasetLoader):
    """
    A `DatasetLoader` for the MULTITACRED dataset.
...
class MULTITACREDSampler(Sampler):
    """
    A data `Sampler` for the MULTITACRED dataset.

    Args:
        dataset_loader (`MULTITACREDDatasetLoader`):
