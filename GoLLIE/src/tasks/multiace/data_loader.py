...
from src.tasks.multiace.guidelines import GUIDELINES
from src.tasks.multiace.guidelines_gold import EXAMPLES
from src.tasks.multiace.prompts import (
        ...
        with open(path, "rt") as in_f:
            for line, eng_text in zip(in_f, translation):
                ...
                if "sentence" in line:
                    ...
                    self.elements[key]["en_entities"] += []
                    self.elements[key]["en_values"] += []
                    self.elements[key]["en_coarse_relations"] += []
